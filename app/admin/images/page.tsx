...
const MANAGED_IMAGES: ImageItem[] = [
  ...
  },
  {
    id: "hero_3",
    label: "Hero foto 3",
    currentSrc: "/landing_page_photos/jw-2_nt_J35jKE-unsplash.jpg",
    description: "Achtergrondafbeelding hero carousel",
  },
  {
    id: "hero_4",
    label: "Hero foto 4",
    currentSrc: "/landing_page_photos/margaret-polinder-3DsMhQF9aB0-unsplash.jpg",
    description: "Achtergrondafbeelding hero carousel",
  },
  {
    id: "hero_5",
  ...
  },
  {
    id: "hero_6",
    label: "Hero foto 6",
    currentSrc: "/landing_page_photos/nick-G7nq4FIFo_M-unsplash.jpg",
    description: "Achtergrondafbeelding hero carousel",
  },
  {
    id: "hero_7",
    label: "Hero foto 7",
    currentSrc: "/landing_page_photos/ries-bosch-jXHaV2nBYEE-unsplash.jpg",
    description: "Achtergrondafbeelding hero carousel",
  },
  {
    id: "success_bg",
